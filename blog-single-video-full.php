					...
					<div class="container">
						<div class="row">
							...
							<div class="col-md-12 text-center text-lg-left">
								<h1 class="color-main">Blog Video Post without Sidebar</h1>
								<ol class=" breadcrumb">
									...
									<li class="breadcrumb-item active">
										Blog Video Post without Sidebar
									</li>
								</ol>
							</div>
				...
				<div class="container">
					<div class="row">
						...
						<main class="offset-lg-1 col-lg-10">
							<article class="vertical-item content-padding post type-post status-publish format-standard has-post-thumbnail video-post">
								...
								<div class="item-content">
									<header class="entry-header">
										<span class="cat-links">
											...
											<a href="blog-left.php" rel="category tag">
												Delivery
											</a>,
										</span>
										...
										<div class="entry-meta">
											<span class="byline">
												<span class="author vcard">
													...
													<a class="url fn n" href="blog-left.php">
												...
												<span>
													...
													<a href="blog-single-left.php" rel="bookmark">
						...
						<div class="col-md-6 col-xl-3 animate" data-animation="fadeInUp">
							<div class="widget widget_icons_list">
								...
								<div class="media side-icon-box">
									...
									<p class="media-body">
										<a href="#"><span class="__cf_email__" data-cfemail="f4999199919a809bb4918c9599849891da979b99">[email&#160;protected]</span></a>
									</p>
								</div>
