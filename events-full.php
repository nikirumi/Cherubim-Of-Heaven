					...
					<div class="container">
						<div class="row">
							...
							<div class="col-md-12 text-center text-lg-left">
								<h1 class="color-main">Events Fullwidth</h1>
								<ol class=" breadcrumb">
									...
									<div class="col-xl-3 col-lg-5 col-md-5">
										<div class="item-media cover-image">
											...
											<div class="media-links">
												<a class="abs-link" title="" href="event-single-full.php"></a>
											</div>
										</div>
									</div>
						...
						<div class="col-md-6 col-xl-3 animate" data-animation="fadeInUp">
							<div class="widget widget_icons_list">
								...
								<div class="media side-icon-box">
									...
									<p class="media-body">
										<a href="#"><span class="__cf_email__" data-cfemail="18757d757d766c77587d60797568747d367b7775">[email&#160;protected]</span></a>
									</p>
								</div>
