...
<body>
	...
	<div id="canvas">
		<div id="box_wrapper">
			...
			<section class="s-pt-55 s-pb-40 s-py-lg-130 ds s-overlay s-parallax page_404">
				<div class="container">
					<div class="row">
			...
			<section class="s-pt-50 s-pb-60 s-py-lg-60 cs cs2 s-parallax s-overlay page_404">
				<div class="container">
					<div class="row align-items-center">
