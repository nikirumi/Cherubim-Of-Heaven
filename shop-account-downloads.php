...
<body>
	...
	<div id="canvas">
		<div id="box_wrapper">
					...
					<div class="container">
						<div class="row">
							...
							<div class="col-md-12 text-center text-lg-left">
								<h1 class="color-main">Downloads</h1>
								<ol class=" breadcrumb">
			...
			<section class="ls s-pt-55 s-pb-30 s-pt-lg-95 s-pb-lg-100 s-pt-xl-145 s-pb-xl-150">
				<div class="container">
					<div class="row">
									...
									<div class="woocommerce">
										...
										<div class="woocommerce-MyAccount-content">
											...
											<div class="woocommerce-Message woocommerce-Message--info woocommerce-info">
												<a class="woocommerce-Button btn btn-maincolor btn-small" href="shop-right.php"><span>Go shop</span></a>
						...
						<div class="col-md-6 col-xl-3 animate" data-animation="fadeInUp">
							<div class="widget widget_icons_list">
								...
								<div class="media side-icon-box">
									...
									<p class="media-body">
										<a href="#"><span class="__cf_email__" data-cfemail="afc2cac2cac1dbc0efcad7cec2dfc3ca81ccc0c2">[email&#160;protected]</span></a>
									</p>
								</div>
