...
<html class="no-js">
<head>
	<title>Cherubim Of Heaven - Multipurpose Funeral Service - FAQ</title>
	<meta charset="utf-8">
		...
		<div id="box_wrapper">
			...
			<section class="ls s-pt-55 s-pb-60 s-pt-lg-95 s-pb-lg-100 s-pt-xl-145 s-pb-xl-150">
				<div class="container">
					<div class="row">
						<div class="col-lg-6">
							<h3 class="special-heading"><span class="color-main">General</span> Questions</h3>
							<div class="divider-20 d-lg-none"></div>
							...
							<!-- collapse -->
							<div class="divider-55 d-lg-none"></div>
						</div>

						<div class="col-lg-6">
							<h3 class="special-heading"><span class="color-main">Other</span> Questions</h3>
							<div class="divider-20 d-lg-none"></div>
							<div class="divider-40 d-none d-lg-block"></div>
