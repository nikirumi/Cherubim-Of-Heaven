					...
					<div class="container">
						<div class="row">
							...
							<div class="col-md-12 text-center text-lg-left">
								<h1 class="color-main">Single Service</h1>
								<ol class=" breadcrumb">
				...
				<div class="container">
					<div class="row">
						<div class="col-md-5 col-lg-4">
							<div class="ls ms box-shadow p-40">
								<a href="#" class="mb-20 icon-inline">
									<span class="icon-styled color-main fs-40">
										<i class="ico-planning"></i>
									</span>
									<span class="fw-500">Plan Ahead</span>
								</a>
								<a href="#" class="mb-20 icon-inline">
									<span class="icon-styled color-main fs-40">
										<i class="ico-cremation"></i>
									</span>
									<span class="fw-500">Cremations</span>
								</a>
								<a href="#" class="mb-20 icon-inline">
									<span class="icon-styled color-main fs-40">
										<i class="ico-ship"></i>
									</span>
									<span class="fw-500">Ship Outs</span>
								</a>
								<a href="#" class="mb-20 icon-inline">
									<span class="icon-styled color-main fs-40">
										<i class="ico-grave"></i>
									</span>
									<span class="fw-500">Burials</span>
								</a>
								<a href="#" class="mb-20 icon-inline">
									<span class="icon-styled color-main fs-40">
										<i class="ico-favorites"></i>
									</span>
									<span class="fw-500">Experience the Difference</span>
								</a>
								<a href="#" class="icon-inline">
									<span class="icon-styled color-main fs-40">
										<i class="ico-bouquet"></i>
									</span>
									<span class="fw-500">Gift and Flowers</span>
								</a>
							</div>
						</div>
						<div class="col-md-7 col-lg-8">
							...
							<h3 class="mt-30"><span class="color-main">Plan </span>Ahead</h3>
							<p>
								Times are changing…cars are changing. One of the biggest changes in today’s automotive industry is the perception of a “tune-up.” Ask 10 vehicle owners their definition of a tune-up and chances are there’ll be 10 different answers.<br>
								The classic “tune-up” was once the heart of the automotive business and contrary to some
							</p>
