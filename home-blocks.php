...
<head>
	...
	<meta name="viewport" conte	nt="width=device-width, initial-scale=1, shrink-to-fit=no">
...
<body>
	...
	<div id="canvas">
		<div id="box_wrapper">
										...
										<div class="intro_layers_wrapper">
											<div class="intro_layers">
												...
												<div class="intro_layer" data-animation="fadeInDown">
													<p class="intro_before_featured_word">today, tomorrow and beyond.</p>
												</div>
												<div class="intro_layer" data-animation="fadeInDown">
			...
			<section class="ls s-pt-55 s-pb-60 s-pt-lg-95 s-pb-lg-100 s-pt-xl-145 s-pb-xl-150 text-center obituaries-section">
				<div class="container">
					<div class="row">
						<div class="col-lg-12">
							...
							<div class="owl-carousel" data-responsive-lg="3" data-responsive-md="3" data-responsive-sm="2" data-responsive-xs="1" data-nav="true" data-autoplay="true" data-loop="true">
			...
			<section class="ls s-pt-55 s-pb-20 s-pt-lg-95 s-pb-lg-85 s-pt-xl-145 s-pb-xl-130 c-mb-20 c-mb-lg-0 c-gutter-0 alt-service-section">
				<div class="container">
			...
			<section class="ls  ms s-pt-55 s-pb-30 s-pb-md-15 s-pt-lg-95 s-pb-lg-55 s-pt-xl-145 s-pb-xl-105 c-gutter-45">
				<div class="container">
					<div class="row">
						<div class="col-12">
							<p class="subtitle text-center">today, tomorrow and beyond.</p>
							<h3 class="special-heading"><span class="color-main">Funeral </span>Services</h3>
							<div class="divider-65 d-none d-lg-block"></div>
			...
			<section class="ls s-pt-0 s-pb-55 s-pt-lg-0 s-pb-lg-95 s-pb-xl-145">
				<div class="container">
					<div class="row">
						<div class="col-12">
							<p class="subtitle text-center">today, tomorrow and beyond.</p>
							<h3 class="special-heading"><span class="color-main">Upcoming </span>Events</h3>
							<div class="divider-65 d-none d-lg-block"></div>
							<article class="post side-item text-center text-md-left content-padding box-shadow event-post">
								<div class="row">
									<div class="col-xl-3 col-lg-5 col-md-5">
										<div class="item-media cover-image">
											<img src="images/gallery/05.jpg" alt="">
											<div class="media-links">
												<a class="abs-link" title="" href="event-single-%40%40type.php"></a>
											</div>
										</div>
									</div>
									<div class="col-xl-9 col-lg-7 col-md-6">
										<div class="item-content">
											<div class="tagcloud">
												<a href="blog-right.php" class="tag-cloud-link">
													Funeral
												</a>
											</div>
			...
			<section class="ls ms s-pt-55 s-pb-55 s-py-lg-95 s-py-xl-145 container-px-0">
				<div class="container-fluid">
					<div class="row">
						<div class="col-sm-12 text-center">
							<p class="subtitle text-center">today, tomorrow and beyond.</p>
							<h3 class="special-heading"><span class="color-main">Alt Our </span>Team</h3>
							<div class="divider-65 d-none d-lg-block"></div>
							<div class="owl-carousel team-alt-carousel" data-margin="10" data-responsive-lg="4" data-responsive-sm="2" data-responsive-xs="1" data-nav="false" data-loop="true" data-autoplay="false">
								<div class="vertical-item box-shadow content-padding padding-small text-center">
									<div class="item-media">
									...
									<div class="item-content content-absolute box-shadow">
										<h6 class="team-name">
											<a href="team-single.php">Louise J. Neal</a>
										</h6>
										<p class="letter-spacing position">
											manager
										</p>
			...
			<section class="ls s-pt-55 s-pb-10 s-py-lg-95 s-py-xl-145 choose-us-section text-center text-lg-left">
				<div class="container">
					<div class="row">
						<div class="col-12">
							<p class="subtitle text-center">today, tomorrow and beyond.</p>
							<h3 class="special-heading"><span class="color-main">Why </span>Choose Us</h3>
							<div class="divider-65 d-none d-lg-block"></div>
							<div class="row align-items-center">
								<div class="col-lg-4">
									<div class="media centered-media featured-icon-left">
										...
										<div class="media-body">
											...
											<p>
												We share information and strive to create an environment that welcomes
											</p>
										</div>
									</div>
									<div class="divider-105 d-none d-lg-block"></div>
									<div class="media centered-media">
										<div class="icon-styled color-main fs-40">
											<i class="ico-customer"></i>
										</div>
										<div class="media-body">
											<h6>
											...
											<p>
												We appreciate the power of diverse perspectives.
											</p>
										</div>
									</div>
									<div class="divider-105 d-none d-lg-block"></div>
								...
								<div class="col-lg-4">
									<div class="media centered-media featured-icon-right">
										<div class="icon-styled color-main fs-40">
											<i class="ico-operator"></i>
										</div>
										<div class="media-body">
											<h6>
											...
											<p>
												Our success is directly linked to the quality of service we deliver.
											</p>
										</div>
									</div>
									<div class="divider-105 d-none d-lg-block"></div>
									<div class="media centered-media">
										...
										<div class="media-body">
											...
											<p>
												We are wired to roll up our sleeves and help.
											</p>
										</div>
									</div>
									<div class="divider-105 d-none d-lg-block"></div>
									<div class="media centered-media featured-icon-right">
										...
										<div class="media-body">
											...
											<p>
												We are extremely responsive to requests, we seek to understand
											</p>
										</div>
									</div>
								</div>
			...
			<section class="ls ms c-gutter-0 text-center text-md-left side-form">
				...
				<div class="row align-items-center">
					<div class="col-md-6">
						<img src="images/form-left-image02.jpg" alt="">
					</div>
					<div class="col-md-6 animate" data-animation="moveFromLeft">
						<div class=" centered-content">
							<div class="divider-95 d-none d-xl-block"></div>
							<div class="divider-55 d-xl-none"></div>
							<p class="subtitle">today, tomorrow and beyond.</p>
			...
			<section id="steps" class="ls s-pt-55 s-pt-lg-95 s-pt-xl-145 c-gutter-60">
				<div class="container">
					<div class="row">
						<div class="col-12 text-center">
							<p class="subtitle">today, tomorrow and beyond.</p>
							<h3 class="special-heading"><span class="color-main">How </span>It Works</h3>
							<div class="divider-65 d-none d-lg-block"></div>
						</div>
					</div>
					<div class="steps-alt">
						<div class="step text-center">
							<div class="step-image">
								<img src="images/step07.jpg" alt="">
							</div>
							<h5 class="mt-0"><span class="color-main fs-40">01</span> Strategy</h5>
						</div>
						<div class="step text-center">
							<div class="step-image">
								<img src="images/step05.jpg" alt="">
							</div>
							<h5 class="mt-0"><span class="color-main fs-40">02</span> Planning</h5>
						</div>
						<div class="step text-center">
							<div class="step-image">
								<img src="images/step06.jpg" alt="">
							</div>
							<h5 class="mt-0"><span class="color-main fs-40">03</span> Build</h5>
						</div>
					</div>
				</div>
			</section>
			...
			<section class="ls s-pt-50 s-pb-55 s-pt-lg-90 s-pb-lg-95 s-pt-xl-140 s-pb-xl-145">
				<div class="container">
					<div class="row">
						<div class="col-lg-12">
							<p class="subtitle text-center">today, tomorrow and beyond.</p>
							<h3 class="special-heading"><span class="color-main">Our </span>Gallery</h3>
							<div class="divider-65 d-none d-lg-block"></div>
										...
										<div class="item-media">
											...
											<div class="media-links">
												<div class="links-wrap">
													<a class="link-zoom photoswipe-link" data-width="585" data-heigt="780" href="images/gallery/14.jpg"></a>
												</div>
											</div>
										</div>
										<div class="item-content gradientdarken-background">
											<h6>
												<a href="gallery-single.php">Consetetur sadipscing elitr, sed diam nonumy</a>
											</h6>
										</div>
									</div>
								</div>
			...
			<section class="ls s-pt-0 s-pb-30 s-pb-lg-70 s-pb-xl-120">
				<div class="container">
					<div class="row">
						<div class="col-lg-12">
							<p class="subtitle text-center">today, tomorrow and beyond.</p>
							...
							<div class="row isotope-wrapper masonry-layout c-mb-30 c-gutter-30">
								...
								<div class="col-xl-4 col-sm-6">
									<div class="vertical-item item-gallery text-center ds">
										...
										<div class="item-content gradientdarken-background">
											<h6>
												<a href="gallery-single.php">Lorem ipsum dolor sit</a>
											</h6>
										</div>
									</div>
								</div>
								...
								<div class="col-xl-4 col-sm-6">
									<div class="vertical-item item-gallery text-center ds">
										...
										<div class="item-content gradientdarken-background">
											<h6>
												<a href="gallery-single.php">Amet consetetur sadipscing</a>
											</h6>
										</div>
									</div>
								</div>
								...
								<div class="col-xl-4 col-sm-6">
									<div class="vertical-item item-gallery text-center ds">
										...
										<div class="item-content gradientdarken-background">
											<h6>
												<a href="gallery-single.php">Elitr sed diam nonumy</a>
											</h6>
										</div>
									</div>
								</div>
								...
								<div class="col-xl-4 col-sm-6">
									<div class="vertical-item item-gallery text-center ds">
										...
										<div class="item-content gradientdarken-background">
											<h6>
												<a href="gallery-single.php">Tempor invidunt ut</a>
											</h6>
										</div>
									</div>
								</div>
								...
								<div class="col-xl-4 col-sm-6">
									<div class="vertical-item item-gallery text-center ds">
										...
										<div class="item-content gradientdarken-background">
											<h6>
												<a href="gallery-single.php">Labore et dolore magna</a>
											</h6>
										</div>
									</div>
								</div>
								...
								<div class="col-xl-4 col-sm-6">
									<div class="vertical-item item-gallery text-center ds">
										...
										<div class="item-content gradientdarken-background">
											<h6>
												<a href="gallery-single.php">Aliquyam erat sed diam</a>
											</h6>
										</div>
									</div>
								</div>
...
<!-- Mirrored from html.modernwebtemplates.com/memento/home-blocks.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 14 Nov 2024 06:47:42 GMT -->
</html>