...
<body>
	...
	<div id="canvas">
		<div id="box_wrapper">
					...
					<div class="container">
						<div class="row">
							...
							<div class="col-md-12 text-center text-lg-left">
								<h1 class="color-main">Shop - Addresses</h1>
								<ol class=" breadcrumb">
			...
			<section class="ls s-pt-55 s-pb-35 s-pt-lg-95 s-pb-lg-100 s-pt-xl-145 s-pb-xl-150">
				<div class="container">
					<div class="row">
						...
						<div class="col-md-6 col-xl-3 animate" data-animation="fadeInUp">
							<div class="widget widget_icons_list">
								...
								<div class="media side-icon-box">
									...
									<p class="media-body">
										<a href="#"><span class="__cf_email__" data-cfemail="036e666e666d776c43667b626e736f662d606c6e">[email&#160;protected]</span></a>
									</p>
								</div>
