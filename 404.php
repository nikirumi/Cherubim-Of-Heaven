...
<html class="no-js">
<head>
	<title>Cherubim Of Heaven - Multipurpose Funeral Service - 404</title>
	<meta charset="utf-8">
...
<body>
	...
	<div id="canvas">
		<div id="box_wrapper">
			...
			<section class="ds s-pt-45 s-pb-95 s-py-lg-125 s-overlay error-404 not-found page_404">
				<div class="container">
					<div class="row">
						...
						<div class="col-sm-12 text-center">
							...
							<div class="page-content">
								...
								<p class="buttons_404">
									<a href="index.php" class="btn btn-big btn-maincolor">Go Home</a>
				...
				<div class="divider-115 d-none d-lg-block"></div>
			</section>
