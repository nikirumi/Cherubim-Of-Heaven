	...
	<div id="canvas">
		<div id="box_wrapper">
					...
					<div class="container">
						<div class="row">
							...
							<div class="col-md-12 text-center text-lg-left">
								<h1 class="color-main">Contact Us</h1>
								<ol class=" breadcrumb">
						...
						<ul class="list-unstyled">
							...
							<li>
								<span class="icon-inline">
									...
									<span>
										<a href="#" class="__cf_email__" data-cfemail="c5a8a4aca985a0bda4a8b5a9a0eba6aaa8">[email&#160;protected]</a>
									</span>
								</span>
							</li>
						</ul>
						...
						<ul class="list-unstyled">
							...
							<li>
								<span class="icon-inline">
									...
									<span>
										<a href="#" class="__cf_email__" data-cfemail="bed3dfd7d2fedbc6dfd3ced2db90ddd1d3">[email&#160;protected]</a>
									</span>
								</span>
							</li>
						</ul>
						...
						<div class="col-lg-4 animate" data-animation="pullDown">
							<div class="media box-shadow">
								...
								<div class="media-body">
									<h6>Email</h6>
									<p>
										<a href="#"><span class="__cf_email__" data-cfemail="d5b8b0b895b0adb4b8a5b9b0fbb6bab8">[email&#160;protected]</span></a><br>
										<a href="#"><span class="__cf_email__" data-cfemail="ee87808881ae8b968f839e828bc08d8183">[email&#160;protected]</span></a><br>
									</p>
								</div>
							</div>
						</div>
			...
			<section class="ls ms s-pt-55 s-pb-55 s-pt-lg-95 s-pb-lg-100 s-pt-xl-145 s-pb-xl-150">
				<div class="container">
					<div class="row">
						<div class="m-auto col-lg-9 animate" data-animation="scaleAppear">
									...
									<div class="row">
										...
										<div class="col-sm-12">
											<div class="form-group has-placeholder">
												...
												<i class="ico-pen"></i>
												<textarea aria-required="true" rows="7" cols="45" name="message" id="message" class="form-control" placeholder="Your Message"></textarea>
											</div>
										</div>
									</div>
									<div class="row mt-35">
						...
						<div class="col-md-6 col-xl-3 animate" data-animation="fadeInUp">
							<div class="widget widget_icons_list">
								...
								<div class="media side-icon-box">
									...
									<p class="media-body">
										<a href="#"><span class="__cf_email__" data-cfemail="48252d252d263c27082d30292538242d662b2725">[email&#160;protected]</span></a>
									</p>
								</div>
